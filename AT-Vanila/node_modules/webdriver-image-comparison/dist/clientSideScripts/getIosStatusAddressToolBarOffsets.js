 ...
 */
export default function getIosStatusAddressToolBarOffsets(iosOffsets, isLandscape) {
    ...
    const offsetPortraitHeight = Object.keys(iosOffsets[deviceType]).indexOf(portraitHeight.toString()) > -1 ? portraitHeight : defaultPortraitHeight;
   ...
   */
    ...
    const toolBarOffsets = isLandscape || toolBarHeight <= 0
    ...
    const sideBarOffsets = isLandscape && !isIphone
        ? {
