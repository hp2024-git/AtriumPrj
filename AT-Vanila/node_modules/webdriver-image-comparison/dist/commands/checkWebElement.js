 ...
 */
export default async function checkWebElement(methods, instanceData, folders, element, tag, checkElementOptions, 
...
isNativeContext) {
    ...
    const { devicePixelRatio, fileName, isLandscape } = await saveWebElement(methods, instanceData, folders, element, tag, saveElementOptions, isNativeContext);
