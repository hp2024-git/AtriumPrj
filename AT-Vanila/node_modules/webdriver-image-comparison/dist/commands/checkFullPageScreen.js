 ...
 */
export default async function checkFullPageScreen(methods, instanceData, folders, tag, checkFullPageOptions, isNativeContext) {
    ...
    const { devicePixelRatio, fileName, isLandscape } = await saveFullPageScreen(methods, instanceData, folders, tag, saveFullPageOptions, isNativeContext);
